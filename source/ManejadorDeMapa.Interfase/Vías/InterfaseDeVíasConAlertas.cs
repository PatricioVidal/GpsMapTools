...
{
  /// <summary>
  /// Interfase de Vías con alertas.
  /// </summary>
  public partial class InterfaseDeVíasConAlertas : InterfaseBase
  {
    #region Campos
    ...
    public override ManejadorDeMapa ManejadorDeMapa
    {
      set
      {
        ...
        if (value != null)
        {
          miBuscadorDeAlertas = value.ManejadorDeVías.BuscadorDeAlertas;
    ...
    /// Constructor.
    /// </summary>
    public InterfaseDeVíasConAlertas()
    {
      InitializeComponent();
