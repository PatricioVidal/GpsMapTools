...
namespace GpsYv.ManejadorDeMapa
{
  ...
  public class CampoEsCiudad : Campo
  {
    ...
    /// <summary>
    /// Devuelve una variable lógica que indica si es una ciudad.
    /// </summary>
    ...
    /// Constructor.
    /// </summary>
    /// <param name="elEsCiudad">Variable lógica que indica si es una ciudad.</param>
    ...
    public override bool Equals(object elObjecto)
    {
      ...
      CampoEsCiudad comparador = elObjecto as CampoEsCiudad;
