...
{
  partial class InterfaseDePdisConAlertas
  {
    /// <summary> 
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InterfaseDePdisConAlertas));
      this.miInterfaseListaConMapaDePdis = new GpsYv.ManejadorDeMapa.Interfase.Pdis.InterfaseListaConMapaDePdis();
      this.columnaDetalles = new System.Windows.Forms.ColumnHeader();
      ...
      // columnaDetalles
      // 
      resources.ApplyResources(this.columnaDetalles, "columnaDetalles");
      // 
      // InterfaseDePdisConAlertas
      // 
      ...
      this.Font = null;
      this.Name = "InterfaseDePdisConAlertas";
    ...
    private GpsYv.ManejadorDeMapa.Interfase.Pdis.InterfaseListaConMapaDePdis miInterfaseListaConMapaDePdis;
    private System.Windows.Forms.ColumnHeader columnaDetalles;
  }
}
